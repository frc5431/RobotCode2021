...
public class ShootSuperCommand extends SequentialCommandGroup {
    public ShootSuperCommand(Intake intake, Hopper hopper, Feeder feeder, Flywheel flywheel, Drivebase drivebase, Limelight limelight) {
        addCommands(
            // Target
            new Targetor(drivebase, limelight),
             // Bring up to speed
            new FlywheelCommand(flywheel, Speeds.FULL), // Waits till up to speed
