...
public class Systems {
    ...
    private final BaseTalon drivebase_Falcon_Left_Back;
    private final BaseTalon drivebase_Falcon_Left_Front;

    private final BaseTalon drivebase_Falcon_Right_Back;
    private final BaseTalon drivebase_Falcon_Right_Front;
    ...
    public Systems() {
        ...
        if (Robot.isReal()) {
            ...
            drivebase_Falcon_Left_Back = new WPI_TalonSRX(Constants.DRIVEBASE_BACK_LEFT_ID);
            drivebase_Falcon_Left_Front = new WPI_TalonSRX(Constants.DRIVEBASE_FRONT_LEFT_ID);
            drivebase_Falcon_Right_Back = new WPI_TalonSRX(Constants.DRIVEBASE_BACK_RIGHT_ID);
            drivebase_Falcon_Right_Front = new WPI_TalonSRX(Constants.DRIVEBASE_FRONT_RIGHT_ID);
        }
     ...
     */
    public List<SpeedController> getAllFalcons() {
        return List.of((SpeedController) drivebase_Falcon_Left_Back, (SpeedController) drivebase_Falcon_Left_Front,
                (SpeedController) drivebase_Falcon_Right_Back, (SpeedController) drivebase_Falcon_Right_Front,
                elevator_Falcon, flywheel_Falcon_Left, flywheel_Falcon_Right, intake_Falcon, feeder_Falcon,
                pivot_Falcon);
    }
}