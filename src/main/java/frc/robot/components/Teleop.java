...
//             // robot.getBalancer().set((driver.getRawButton(Xbox.Button.BUMPER_R) ? 1 : 0) - (driver.getRawButton(Xbox.Button.BUMPER_L) ? 1 : 0));
//             robot.getElevator().set(driver.getRawAxis(Xbox.Axis.TRIGGER_RIGHT) - driver.getRawAxis(Xbox.Axis.TRIGGER_LEFT));
